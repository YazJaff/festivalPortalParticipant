...
public class FERSDbQuery {
	...
	private String updateSeatNumber="";
	...
	public String getUpdateSeatNumber() {
		return updateSeatNumber;
	}

	public void setUpdateSeatNumber(String updateSeatNumber) {
		this.updateSeatNumber = updateSeatNumber;
	}
